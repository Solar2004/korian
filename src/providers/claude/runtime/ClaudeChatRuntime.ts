/**
 * Korian - Claude Agent SDK wrapper
 *
...
import type { KorianSettings, PermissionMode } from '../../../core/types/settings';
...
export class KorianService implements ChatRuntime {
  ...
  private getLegacyPluginDeps(): KorianPlugin & {
    agentManager?: Pick<AppAgentManager, 'setBuiltinAgentNames'>;
    pluginManager?: AppPluginManager;
  } {
    return this.plugin;
  ...
  constructor(plugin: KorianPlugin, services: ClaudeRuntimeServices | McpServerManager) {
    this.plugin = plugin;
   ...
   */
  private getScopedSettings(): KorianSettings {
