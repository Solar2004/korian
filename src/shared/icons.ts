  ...
  children: [
    {
      tag: 'g',
      attributes: {
        class: 'korian-provider-icon-variant korian-provider-icon-variant--light',
    ...
    },
    {
      tag: 'g',
      attributes: {
        class: 'korian-provider-icon-variant korian-provider-icon-variant--dark',
        transform: 'translate(30 0)',
      },
      children: [
...
export function createProviderIconSvg(
  ...
  svg.classList.add('korian-provider-icon');
