 ...
 * all providers: Korian settings, tab manager state, and session metadata.
 *
...
export interface SharedAppStorage {
  initialize(): Promise<{ korian: Record<string, unknown> }>;
  saveKorianSettings(settings: Record<string, unknown>): Promise<void>;
