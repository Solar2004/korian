...
export interface ProviderRegistration {
  ...
  createTitleGenerationService: (plugin: KorianPlugin) => TitleGenerationService;
  createInstructionRefineService: (plugin: KorianPlugin) => InstructionRefineService;
  createInlineEditService: (plugin: KorianPlugin) => InlineEditService;
