...
export class ProviderRegistry {
  ...
  static createTitleGenerationService(plugin: KorianPlugin, providerId?: ProviderId): TitleGenerationService {
    if (!providerId) {
  ...
  static createInstructionRefineService(plugin: KorianPlugin, providerId: ProviderId = DEFAULT_CHAT_PROVIDER_ID): InstructionRefineService {
    return this.getProviderRegistration(providerId).createInstructionRefineService(plugin);
  }

  static createInlineEditService(plugin: KorianPlugin, providerId: ProviderId = DEFAULT_CHAT_PROVIDER_ID): InlineEditService {
...
class RoutedTitleGenerationService implements TitleGenerationService {
  ...
  constructor(private readonly plugin: KorianPlugin) {}
